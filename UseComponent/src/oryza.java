 ...
 * @author oryza
 */
public class oryza extends javax.swing.JApplet {

    /**
     * Initializes the applet oryza
     */
    @Override
    public void init() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(oryza.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
